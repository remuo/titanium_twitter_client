...
/**
 Base class for all _titanium_twitter_client_twitter_client views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the _titanium_twitter_client_twitter_client view hierarchy (such as wrapped iOS UIViews) was touched.
