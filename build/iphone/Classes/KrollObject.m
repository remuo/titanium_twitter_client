 ...
 * Copyright (c) 2009-2011 by _titanium_twitter_client_twitter_client, Inc. All Rights Reserved.
...
//@interface _titanium_twitter_client_twitter_clientObject : NSObject
//@end

@interface _titanium_twitter_client_twitter_clientObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[_titanium_twitter_client_twitter_clientObject class]])
		{
			for (NSString *key in [[(_titanium_twitter_client_twitter_clientObject*)o modules] allKeys])
			{
