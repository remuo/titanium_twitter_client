...
//Rare exceptions to indicate a bug in the _titanium_twitter_client code (Eg, function that a subclass should have implemented)
...
/**
 The base class for _titanium_twitter_client_twitter_client proxies.
 */
