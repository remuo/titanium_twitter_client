...
// in simulator we redefine to format for _titanium_twitter_client_twitter_client Developer console
...
{\
	NSString * exceptionName = [@"org.titanium_twitter_client." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titanium_twitter_client";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UI_titanium_twitter_client_twitter_clientNativeItemNone = -1, 
	UI_titanium_twitter_client_twitter_clientNativeItemSpinner = -2,
	UI_titanium_twitter_client_twitter_clientNativeItemProgressBar = -3,
	
	UI_titanium_twitter_client_twitter_clientNativeItemSlider = -4,
	UI_titanium_twitter_client_twitter_clientNativeItemSwitch = -5,
	UI_titanium_twitter_client_twitter_clientNativeItemMultiButton = -6,
	UI_titanium_twitter_client_twitter_clientNativeItemSegmented = -7,
	
	UI_titanium_twitter_client_twitter_clientNativeItemTextView = -8,
	UI_titanium_twitter_client_twitter_clientNativeItemTextField = -9,
	UI_titanium_twitter_client_twitter_clientNativeItemSearchBar = -10,
	
	UI_titanium_twitter_client_twitter_clientNativeItemPicker = -11,
	UI_titanium_twitter_client_twitter_clientNativeItemDatePicker = -12,
	
	UI_titanium_twitter_client_twitter_clientNativeItemInfoLight = -13,
	UI_titanium_twitter_client_twitter_clientNativeItemInfoDark = -14,
	
	UI_titanium_twitter_client_twitter_clientNativeItemDisclosure = -15,
	
	UI_titanium_twitter_client_twitter_clientNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all _titanium_twitter_client_twitter_client instances of
