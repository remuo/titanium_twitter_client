...
/**
 The base class for all _titanium_twitter_client_twitter_client modules
 */
...
/**
 _titanium_twitter_client_twitter_client Platform calls this method on startup.
 */
-(void)startup;

/**
 _titanium_twitter_client_twitter_client Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 _titanium_twitter_client_twitter_client Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 _titanium_twitter_client_twitter_client Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 _titanium_twitter_client_twitter_client Platform calls this method on resume.
 @param sender The sender of the event.
 */
