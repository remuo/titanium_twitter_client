...
static NSString * const k_titanium_twitter_client_twitter_clientJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_titanium_twitter_clientInjection
{
	...
	[html appendString:k_titanium_twitter_client_twitter_clientJavascript];
...
{
	// attempt to make well-formed HTML and inject in our _titanium_twitter_client_twitter_client bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _titanium_twitter_clientInjection]];
