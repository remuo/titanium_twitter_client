...
@interface _titanium_twitter_client_twitter_clientObject : KrollCoverageObject {
#else
@interface _titanium_twitter_client_twitter_clientObject : KrollObject {
#endif
@private
...
extern NSString * _titanium_twitter_client_twitter_client$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	_titanium_twitter_client_twitter_clientObject *_titanium_twitter_client;
    KrollObject* console;
	BOOL shutdown;
